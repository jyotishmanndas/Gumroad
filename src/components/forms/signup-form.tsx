    ...
    return (
        <div className="gap-6 flex flex-col">
            <div className="flex items-center justify-between pt-8">
                ...
                <Link href="/login" className=" text-md text-white font-semibold underline">
                    Log in
                </Link>
            </div>
            <h1 className="text-4xl font-semibold text-neutral-300 pt-8">
                Join over 218,134 creators who have earned over $1,091,510,025 on Gumroad selling digital products and memberships.
            </h1>
            ...
            <div className="mt-6 flex flex-col gap-4">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7">
                        ...
                        <Button size="lg" type="submit" className="w-full bg-white hover:bg-pink-400" variant="elevated" disabled={signUpMutation.isPending}>
                            Create account
                        </Button>
                    </form>
                </Form>
